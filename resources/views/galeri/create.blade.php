<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-semibold text-slate-950">Tambah Galeri</h2>
                <p class="mt-1 text-sm text-slate-500">Unggah foto dokumentasi kegiatan.</p>
            </div>
    ...
    <div class="rounded-[32px] border border-slate-200 bg-white p-6 shadow-panel">
        <form action="{{ route('galeri.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input id="foto" name="foto" type="file" accept="image/*" class="mt-2" required />
